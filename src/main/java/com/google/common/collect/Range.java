...
import com.google.common.truth.Iterables;
 ...
 * appropriate {@link DiscreteDomain} to {@code ContiguousSet#create}.
 *
 ...
 *       1 to 100."
 *   <li>When evaluated as a {@code Predicate}, a range yields the same result as invoking {@link
 *       #contains}.
...
public final class Range<C extends Comparable>
    ...
    /**
     * Provided only to satisfy the {@link Predicate} interface; use {@link #contains}
     *     instead.
     */
    @Override
