 ...
 *
 * <p>Common implementations include {@code ImmutableMultiset}, {@code HashMultiset}, and {@code
 * ConcurrentHashMultiset}.
 *
 * <p>If your values may be zero, negative, or outside the range of an int, you may wish to use
 * {@code com.google.common.util.concurrent.AtomicLongMap} instead. Note, however, that unlike
